;;;; =====================================================
;;;; Spreadsheet GUI v0.6
;;;; Common Lisp + LTK Spreadsheet Application
;;;; 
;;;; This is the final single-file version.
;;;; For continued development, please use SSP:
...
;;;;   - Modular design (preparation for SSP)
;;;;   - Package: ss-gui (for backward compatibility)
;;;; 
;;;; Usage: (load "spreadsheet-gui-v0.6.lisp") (ss-gui:start)
;;;; =====================================================
  ...
  (let ((cells-data (collect-cells-data)))
    (with-open-file (out filename 
      ...
      (let ((*print-pretty* t)
        ...
        (format out ";;;; Spreadsheet File (.ssp)~%")
...
(defun update-window-title ()
  "ウィンドウタイトルを更新"
  (wm-title *tk* (format nil "Spreadsheet GUI v0.6 [~Dx~D]~a" 
...
;;; ロード時メッセージ
(format t "~%╔══════════════════════════════════════════════════════════╗~%")
(format t "║  Spreadsheet GUI v0.6 (Final Single-File Version)        ║~%")
(format t "╠══════════════════════════════════════════════════════════╣~%")
(format t "║  For continued development, please use SSP:              ║~%")
(format t "║  https://github.com/fukuyori/ssp                         ║~%")
(format t "╚══════════════════════════════════════════════════════════╝~%")
(format t "~%Start: (ss-gui:start)~%")
